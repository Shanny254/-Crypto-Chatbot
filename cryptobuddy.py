...
class CryptoBuddy:
    def __init__(self):
        ...
        # Ethics disclaimer
        self.ethics_disclaimer = "\n\n **IMPORTANT**: Crypto investments are highly risky and volatile. This is for educational purposes only. Always do your own research and consult with financial advisors before making investment decisions!"
    ...
    def chat(self):
        ...
        if self.fetch_real_time_data():
            ...
            print("Using fallback data - real-time features limited")
